  ...
  _render() {
    ...
    this.shadowRoot.innerHTML = `<style>
      ...
      *{box-sizing:border-box}
      ...
      .tile{display:flex;flex-direction:column;align-items:center;gap:5px;padding:12px 6px;border:1px solid var(--edge);border-radius:14px;background:transparent;color:var(--primary-text-color);cursor:pointer;text-align:center;position:relative}
      .tile:hover{border-color:var(--primary-text-color)}
      .tile.issue{border-color:color-mix(in srgb,var(--danger) 45%,var(--edge))}
      ...
      .card2{display:flex;align-items:center;gap:10px;padding:11px 12px;border:1px solid var(--edge);border-radius:14px}
